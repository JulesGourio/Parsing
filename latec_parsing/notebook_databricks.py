...
OCR_RUNTIME_ENV = {
    ...
    "OCR_MAX_PDF_OCR_ATTEMPTS": os.getenv("OCR_MAX_PDF_OCR_ATTEMPTS", "32"),
    "OCR_PDF_OCR_TIME_BUDGET_RATIO": os.getenv("OCR_PDF_OCR_TIME_BUDGET_RATIO", "0.72"),
    "OCR_TABLE_RECONSTRUCTION_ENABLED": os.getenv("OCR_TABLE_RECONSTRUCTION_ENABLED", "1"),
    "OCR_TABLE_MIN_BOXES": os.getenv("OCR_TABLE_MIN_BOXES", "8"),
    "OCR_TABLE_MIN_COLUMNS": os.getenv("OCR_TABLE_MIN_COLUMNS", "2"),
    "OCR_TABLE_MIN_DENSITY": os.getenv("OCR_TABLE_MIN_DENSITY", "0.28"),
    "OCR_DIAGRAM_SUMMARY_ENABLED": os.getenv("OCR_DIAGRAM_SUMMARY_ENABLED", "1"),
    "CHUNK_MARKDOWN_IGNORE_PAGE_MARKERS": os.getenv("CHUNK_MARKDOWN_IGNORE_PAGE_MARKERS", "1"),
    "CHUNK_MARKDOWN_MIN_HEADERS": os.getenv("CHUNK_MARKDOWN_MIN_HEADERS", "2"),
    "CHUNK_SHORT_MERGE_ENABLED": os.getenv("CHUNK_SHORT_MERGE_ENABLED", "1"),
    "CHUNK_SHORT_MERGE_TARGET_TOKENS": os.getenv("CHUNK_SHORT_MERGE_TARGET_TOKENS", "90"),
    "MAX_CSV_TABLE_PREVIEW_ROWS": os.getenv("MAX_CSV_TABLE_PREVIEW_ROWS", "80"),
}
