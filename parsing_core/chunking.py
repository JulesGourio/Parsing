...
from .constants import MAX_CHUNK_CHARS, TOKENIZER_ENCODING
...
def _is_probably_markdown(text: str) -> bool:
    header_count = len(MARKDOWN_HEADER_LINE_PATTERN.findall(text))
...
def split_text_to_chunks(
    ...
    def add_chunk(enriched_text: str, metadata: Dict[str, str]) -> None:
        ...
        for piece in _split_oversized_chunk(enriched_text, MAX_CHUNK_CHARS):
            ...
            stable_id = _build_stable_chunk_id(piece, metadata)
    ...
    for semantic_doc in semantic_splits:
        ...
        for sub_chunk in sub_chunks:
            ...
            add_chunk(enriched_text, metadata)
